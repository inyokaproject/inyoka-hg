...
urlpatterns = patterns('inyoka.forum.views',
    ...
    (r'^new_discussion/(?P<article_name>.+)/$', 'edit'),
    (r'^markread/$', 'markread'),
    ...
    (r'^egosearch/$', 'authorsearch'),
    (r'^egosearch/(?P<page>\d+)/$', 'authorsearch'),
    (r'^author/(?P<user>[^/]+)/$', 'authorsearch'),
    (r'^author/(?P<user>[^/]+)/(?P<page>\d+)/$', 'authorsearch'),
