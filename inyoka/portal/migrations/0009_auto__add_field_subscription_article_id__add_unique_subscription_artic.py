...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Subscription', fields ['article_id', 'user']
        db.create_unique('portal_subscription', ['article_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Subscription.article_id'
        db.delete_column('portal_subscription', 'article_id')
    ...
    models = {
        ...
        'portal.subscription': {
            'Meta': {'unique_together': "(('topic_id', 'user'), ('forum_id', 'user'), ('wiki_page', 'user'), ('member', 'user'), ('article_id', 'user'))", 'object_name': 'Subscription'},
            'article_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
