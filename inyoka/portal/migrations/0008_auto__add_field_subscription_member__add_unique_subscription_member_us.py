...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Subscription', fields ['member', 'user']
        db.create_unique('portal_subscription', ['member_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Subscription.member'
        db.delete_column('portal_subscription', 'member_id')
    ...
    models = {
        ...
        'portal.subscription': {
            'Meta': {'unique_together': "(('topic_id', 'user'), ('forum_id', 'user'), ('wiki_page', 'user'), ('member', 'user'))", 'object_name': 'Subscription'},
