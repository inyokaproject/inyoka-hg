...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index('ikhaya_category', ['slug'])

        # Adding index on 'Article', fields ['pub_date']
        db.create_index('ikhaya_article', ['pub_date'])


    def backwards(self, orm):

        # Removing index on 'Article', fields ['pub_date']
        db.delete_index('ikhaya_article', ['pub_date'])

        # Removing index on 'Category', fields ['slug']
        db.delete_index('ikhaya_category', ['slug'])
