...
/**
 * Creates a new GMarkerManager that will show/hide markers on a map.
 *
 * @constructor
 ...
 *                   movements.
 */
function GMarkerManager(map, opt_opts) {
  var me = this;
  me.map_ = map;
  ...
  opt_opts = opt_opts || {};
  me.tileSize_ = GMarkerManager.DEFAULT_TILE_SIZE_;
  
  var maxZoom = GMarkerManager.DEFAULT_MAX_ZOOM_;
  ...
  if (typeof opt_opts.borderPadding == "number") {
    ...
    padding = GMarkerManager.DEFAULT_BORDER_PADDING_;
  }
...
// Static constants:
GMarkerManager.DEFAULT_TILE_SIZE_ = 1024;
GMarkerManager.DEFAULT_MAX_ZOOM_ = 17;
GMarkerManager.DEFAULT_BORDER_PADDING_ = 100;
GMarkerManager.MERCATOR_ZOOM_LEVEL_ZERO_RANGE = 256;


/**
 * Initializes GMarkerManager arrays for all zoom levels
 * Called by constructor and by clearAllMarkers
 */ 
GMarkerManager.prototype.resetManager_ = function() {
  var me = this;
  var mapWidth = GMarkerManager.MERCATOR_ZOOM_LEVEL_ZERO_RANGE;
 ...
 *
 */
GMarkerManager.prototype.getTilePoint_ = function(latlng, zoom, padding) {
 ...
 */
GMarkerManager.prototype.addMarkerBatch_ = function(marker, minZoom, maxZoom) {
 ...
 * shown bounds.
 */
GMarkerManager.prototype.isGridPointVisible_ = function(point) {
  var me = this;
 ...
 */
GMarkerManager.prototype.onMarkerMoved_ = function(marker, oldPoint, newPoint) {
 ...
 */
GMarkerManager.prototype.removeMarker = function(marker) {
  var me = this;
  var zoom = me.maxZoom_;
  var changed = false;
 ...
 */
GMarkerManager.prototype.addMarkers = function(markers, minZoom, opt_maxZoom) {
 ...
 */
GMarkerManager.prototype.getOptMaxZoom_ = function(opt_maxZoom) {
 ...
 */
GMarkerManager.prototype.addMarker = function(marker, minZoom, opt_maxZoom) {
  var me = this;
  var maxZoom = this.getOptMaxZoom_(opt_maxZoom);
 ...
 */
GMarkerManager.prototype.getGridCellCreate_ = function(x, y, z) {
 ...
 * @return {Array} The cell in the array.
 */
GMarkerManager.prototype.getGridCellNoCreate_ = function(x, y, z) {
  var grid = this.grid_[z];
  if (x < 0) {
    x += this.gridWidth_[z];
  }
 ...
 */
GMarkerManager.prototype.getGridBounds_ = function(bounds, zoom, swPadding,
                                                  nePadding) {
 ...
 */
GMarkerManager.prototype.getMapGridBounds_ = function() {
  var me = this;
 ...
 *
 */
GMarkerManager.prototype.onMapMoveEnd_ = function() {
  var me = this;
 ...
 */
GMarkerManager.prototype.objectSetTimeout_ = function(object, command, milliseconds) {
 ...
 */
GMarkerManager.prototype.updateMarkers_ = function() {
  var me = this;
 ...
 */
GMarkerManager.prototype.notifyListeners_ = function() {
 ...
 */
GMarkerManager.prototype.processAll_ = function(bounds, callback) {
 ...
 * @param {Function} callback The function to call for each marker.
 */
GMarkerManager.prototype.processCellMarkers_ = function(x, y, z, callback) {
 ...
 * @param {Number} z The z coordinate of the cell.
 */
GMarkerManager.prototype.removeCellMarkers_ = function(x, y, z) {
 ...
 * @param {Number} z The z coordinate of the cell.
 */
GMarkerManager.prototype.addCellMarkers_ = function(x, y, z) {
 ...
 * the current GMarkerManager object as the instance.
 *
 ...
 */
GMarkerManager.prototype.rectangleDiff_ = function(bounds1, bounds2, callback) {
  var me = this;
 ...
 */
GMarkerManager.prototype.rectangleDiffCoords = function(bounds1, bounds2, callback) {
 ...
 */
GMarkerManager.prototype.removeFromArray = function(array, value, opt_notype) {
  var shift = 0;
