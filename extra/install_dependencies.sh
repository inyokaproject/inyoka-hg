...
cd /opt
sudo su
aptitude install mercurial subversion python-simplejson mysql-server mysql-client python-openid
...
sudo ln -s /opt/pygments/docs/pygmentize.1 /usr/share/man/man1/
